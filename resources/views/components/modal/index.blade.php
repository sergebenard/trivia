...
>
    ...
    <div {{ $attributes->merge(['class' => 'rounded-lg overflow-hidden shadow-xl transform transition-all sm:w-full sm:mx-auto ' . $maxWidth]) }} x-show="show"
